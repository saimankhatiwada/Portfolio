...
{
    Task<Result<PaginationResult<User>>> GetAllAsync(string? search, string? sort, string? field, int page, int pageSize, CancellationToken cancellationToken = default);
